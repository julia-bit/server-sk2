...
#define HT_SIZE_MIN 128
     ...
     *         -1 in case of errors
     */
    int ht_get_or_set(hashtable_t *table, void *key, size_t klen, void *data, size_t dlen, void **cur_data,
                      size_t *cur_len);
     ...
     *       so the caller will be responsible of releasing the previous data once done with it
     */
    int ht_set_copy(hashtable_t *table, void *key, size_t klen, void *data, size_t dlen, void **prev_data,
                    size_t *prev_len);
     ...
     *        -1 on error
     */
    typedef int (*ht_pair_callback_t)(hashtable_t *table, void *key, size_t klen, void **value, size_t *vlen,
                                      void *user);
     ...
     *         HT_ITERATOR_REMOVE_AND_STOP to remove the current item from the table and stop the iteration
     */
    typedef ht_iterator_status_t (*ht_value_iterator_callback_t)(hashtable_t *table, void *value, size_t vlen,
                                                                 void *user);
     ...
     *         HT_ITERATOR_REMOVE_AND_STOP to remove the current item from the table and stop the iteration
     */
    typedef ht_iterator_status_t (*ht_pair_iterator_callback_t)(hashtable_t *table, void *key, size_t klen, void *value,
                                                                size_t vlen, void *user);
