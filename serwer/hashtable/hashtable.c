...
#define HT_KEY_EQUALS(_k1, _kl1, _k2, _kl2)                                                                            \
    (((char *)(_k1))[0] == ((char *)(_k2))[0] && (_kl1) == (_kl2) && memcmp((_k1), (_k2), (_kl1)) == 0)
...
static inline void ht_grow_table(hashtable_t *table)
{
    ...
    ht_items_list_t **items_list = (ht_items_list_t **)calloc(new_size, sizeof(ht_items_list_t *));
...
static inline int ht_set_internal(hashtable_t *table, void *key, size_t klen, void *data, size_t dlen, void **prev_data,
                                  size_t *prev_len, int copy, int inx)
{
    void *prev = NULL;
    size_t plen = 0;
...
int ht_get_and_set(hashtable_t *table, void *key, size_t klen, void *data, size_t dlen, void **prev_data,
                   size_t *prev_len)
{
...
static int ht_set_if_equals_helper(hashtable_t *table, void *key __attribute__((unused)),
                                   size_t klen __attribute__((unused)), void **value, size_t *vlen, void *user)
{
...
int ht_set_if_equals(hashtable_t *table, void *key, size_t klen, void *data, size_t dlen, void *match,
                     size_t match_size, void **prev_data, size_t *prev_len)
{
    if (!match && match_size == 0)
        return ht_set_if_not_exists(table, key, klen, data, dlen);

    ht_set_if_equals_helper_arg_t arg = {.data = data,
                                         .dlen = dlen,
                                         .match = match,
...
static int ht_delete_helper(hashtable_t *table, void *key __attribute__((unused)), size_t klen __attribute__((unused)),
...
int ht_unset(hashtable_t *table, void *key, size_t klen, void **prev_data, size_t *prev_len)
{
    ht_delete_helper_arg_t arg = {
        .unset = 1, .prev_data = prev_data, .prev_len = prev_len, .match = NULL, .match_size = 0};

    return ht_call_internal(table, key, klen, ht_delete_helper, (void *)&arg);
}

static inline int ht_delete_internal(hashtable_t *table, void *key, size_t klen, void **prev_data, size_t *prev_len,
                                     void *match, size_t match_size)
{

    ht_delete_helper_arg_t arg = {
        .unset = 0, .prev_data = prev_data, .prev_len = prev_len, .match = match, .match_size = match_size};
...
static int ht_get_helper(hashtable_t *table __attribute__((unused)), void *key __attribute__((unused)),
                         size_t klen __attribute__((unused)), void **value, size_t *vlen, void *user)
{
...
static inline void *ht_get_internal(hashtable_t *table, void *key, size_t klen, size_t *dlen, int copy,
                                    ht_deep_copy_callback_t copy_cb, void *user)
{
    ht_get_helper_arg_t arg = {.data = NULL, .dlen = dlen, .copy = copy, .copy_cb = copy_cb, .user = user};
...
static int ht_foreach_key_helper(hashtable_t *table, void *key, size_t klen, void *value __attribute__((unused)),
                                 size_t vlen __attribute__((unused)), void *user)
{
...
static int ht_foreach_value_helper(hashtable_t *table, void *key __attribute__((unused)),
                                   size_t klen __attribute__((unused)), void *value, size_t vlen, void *user)
{
    ht_iterator_arg_t *arg = (ht_iterator_arg_t *)user;
