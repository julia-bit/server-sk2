...
void list_unlock(linked_list_t *list __attribute__((unused)))
{
    MUTEX_UNLOCK(list->lock);
}
...
static inline void list_quick_sort(list_entry_t *head, list_entry_t *tail, list_entry_t *pivot, int length,
